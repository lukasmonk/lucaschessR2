...
class WConfTactics(QtWidgets.QWidget):
    def __init__(self, owner, tactica, ncopia=None):
        ...
        o_col.nueva(
            "JUMPS_SEPARATION", _("Separation"), 80, align_center=True, edicion=Delegados.LineaTexto(is_integer=True)
        )
        ...
        o_col.nueva(
            "PENAL_POSITIONS", _("Positions"), 100, align_center=True, edicion=Delegados.LineaTexto(is_integer=True)
        )
        ...
        o_col.nueva("WEIGHT", _("Weight"), 100, align_center=True, edicion=Delegados.LineaTexto(is_integer=True))
        o_col.nueva("TOTAL", _("Total"), 100, align_center=True)
        o_col.nueva("FROM", _("From"), 100, align_center=True, edicion=Delegados.LineaTexto(is_integer=True))
        o_col.nueva("TO", _("To"), 100, align_center=True, edicion=Delegados.LineaTexto(is_integer=True))
