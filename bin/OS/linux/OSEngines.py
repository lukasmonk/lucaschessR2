...
def read_engines(folder_engines):
    ...
    cm = mas("lc0", "The LCZero Authors", "0.27.0", "https://github.com/LeelaChessZero", "Lc0-0.27.0", 3332, nodes_compatible=True)
    cm.set_uci_option("Hash", "64")
    cm.set_uci_option("Threads", "2")
    cm.set_multipv(10, 500)

    cm = mas("stockfish", "Tord Romstad, Marco Costalba, Joona Kiiski", f"16{bmi2}", "http://stockfishchess.org/", f"Stockfish-16_x64{bmi2}", 3611)
    cm.set_uci_option("Hash", "64")
    cm.set_uci_option("Threads", "2")
    cm.set_multipv(10, 500)
    ...
    mas("amoeba", "Richard Delorme", "2.6", "https://github.com/abulmo/amoeba", "Amoeba-2.6", 2911, nodes_compatible=True)
    ...
    mas("asymptote", "Maximilian Lupke", "0.8", "https://github.com/malu/asymptote", "Asymptote-0.8", 2909, nodes_compatible=True)
    ...
    mas("counter", "Vadim Chizhov", "3.7", "https://github.com/ChizhovVadim/CounterGo", "Counter-3.7", 2963, nodes_compatible=True)
    ...
    mas("daydreamer", "Aaron Becker", "1.75 JA", "http://github.com/AaronBecker/daydreamer/downloads", "Daydreamer-1.75", 2670, nodes_compatible=True)

    mas("delocto", "Moritz Terink", "0.61n", "https://github.com/moterink/Delocto", "Delocto-0.61n", 2625)

    mas("discocheck", "Lucas Braesch", "5.2.1", "https://github.com/lucasart/", "Discocheck-5.2.1", 2700, nodes_compatible=True)
    ...
    mas("greko", "Vladimir Medvedev", "2020.03", "http://greko.su/index_en.html", "GreKo-2020.03", 2580, nodes_compatible=True)

    mas("greko98", "Vladimir Medvedev", "9.8", "http://sourceforge.net/projects/greko", "GreKo98a", 2500, nodes_compatible=True)
    ...
    mas("igel", "Volodymyr Shcherbyna", "3.0.0", "https://github.com/vshcherbyna/igel/", "Igel-3.0.10", 3402, nodes_compatible=True)
    ...
    mas("marvin", "Martin Danielsson", "5.0.0", "https://github.com/bmdanielsson/marvin-chess", "Marvin-5.0.0", 3112,  nodes_compatible=True)

    mas("monolith", "Jonas Mayr", "2.01", "https://github.com/cimarronOST/Monolith", "Monolith-2.01", 3003, nodes_compatible=True)
    ...
    mas("pulse", "Phokham Nonava", "1.6.1", "https://github.com/fluxroot/pulse", "Pulse-1.6.1", 1615, nodes_compatible=True)
    ...
    mas("rodentii", "Pawel Koziol", "0.9.64", "http://www.pkoziol.cal24.pl/rodent/rodent.htm", "RodentII-0.9.64", 2912,  nodes_compatible=True)
    ...
    mas("supernova", "Minkai Yang", "2.3", "https://github.com/MichaeltheCoder7/Supernova", "Supernova-2.3", 2646, nodes_compatible=True)
