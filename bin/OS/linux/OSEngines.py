...
def read_engines(folder_engines):
    ...
    mas("daydreamer", "Aaron Becker", "1.75 JA", "https://github.com/AaronBecker/daydreamer","Daydreamer-1.75", 2670, nodes_compatible=True)
    ...
    mas("texel", "Peter Österlund", "1.06", "https://github.com/peterosterlund2/texel", "Texel-1.06",2900)
