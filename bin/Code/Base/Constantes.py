...
(NO_RATING, GOOD_MOVE, MISTAKE, VERY_GOOD_MOVE, BLUNDER, SPECULATIVE_MOVE, INACCURACY) = range(7)
...
ENG_INTERNAL, ENG_EXTERNAL, ENG_MICGM, ENG_MICPER, ENG_FIXED, ENG_IRINA, ENG_ELO, ENG_RODENT = range(8)
